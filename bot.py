...
content = {"start" : ["date/start.txt", "date/start2.txt"],\
           "kafedra" : "date/kafedra.txt",\
           "teacher" : ["date/teacher.txt", "date/teacher_with_link.txt"],\
           "navch_na_kafedre" : ["date/prunzupu.txt", \
                                 "date/sustema.txt", \
                                 "date/sustema_vazhno.txt", \
                                 "date/sho_maemo.txt", \
                                 "date/spivpraza.txt"],\
           "history" : ["date/foto_history.txt",\
                        "date/year.txt",\
                        "date/pochatok.txt",\
                        "date/math.txt",\
                        "date/math_with_prog.txt",\
                        "date/data_science.txt",\
                        "date/na_kafedre.txt",\
                        "date/pushaemosa.txt"],\
           "audut" : ["date/audut_with_link.txt",\
                      "date/audut.txt",\
                      "date/audut2.txt",\
                      "date/audut3.txt",\
                      "date/audut4.txt"],\
           "vupysknuku" : ["date/vupysknuku_with_link.txt",\
                           "date/vupysknuku.txt",\
                           "date/vupysknuku2",\
                           "date/vupysknuku3",\
                           "date/vupysknuku4",\
                           "date/vupysknuku_with_link2",\
                           "date/vupysknuku5"]}


def start(update, context):
    """Send a message when the command /start is issued."""
    content = "Даров, Артем пидор"
...
def main():
    ...
    dp.add_handler(CallbackQueryHandler(about_of_CMAD_departament,pattern = 'about_of_CMAD_departamnt'))
